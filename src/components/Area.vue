<template>
  <div class="container">
   ...
   <div class="container">
        ...
        <div class="form-group row">
            <div class="form-group">
                    <label for="areaSize">AreaSize:</label>
                    <input type="text" v-model="area.areaSize" class="form-control" id="areaSize" placeholder="Enter areaSize" name="areaSize">
                </div>
        </div>
      <div class="form-group row">
        <div class="col">
  ...
  methods: {
    async SaveBook() {
      if (confirm("Do you want to save this area?")) {
        ...
        await this.$router.push("/addarea");
      }
    },
    Cancel() {
